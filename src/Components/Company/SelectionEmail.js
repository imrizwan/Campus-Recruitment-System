...
class SelectionEmail extends Component {
  ...
  onClick = e => {
    ...
    if (isEmpty(this.state.info)) {
      ...
      const data = {
        studentemail: this.getQueryVariable("mail"),
        position: decodeURI(this.getQueryVariable("position")),
        company: this.getQueryVariable("company"),
        companyemail: this.getQueryVariable("companyemail"),
