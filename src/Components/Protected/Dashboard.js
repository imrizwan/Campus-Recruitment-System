                      ...
                      <div key={index2} className="marginBottom">
                        <div className="card text-justify">
                          ...
                          <div className="card-body">
                            ...
                            {!isEmpty(this.props.profilecreated) ? (
                              !this.props.profilecreated.applied.find(
                                data =>
                                  data.key ===
                                  `${this.props.auth.user.id}${vaccancy._id}${vaccancy.user}`
                              ) ? (
                                <button
                                  type="button"
                          ...
                          <div className="modal-dialog" role="document">
                            <div className="modal-content">
                              ...
                              <div className="modal-body">
                                {this.state.errors.applyforvaccancy ? (
                                  <div style={{ color: "red" }}>
                                    {this.state.errors.applyforvaccancy}
                                  </div>
                                ) : (
...
export default compose(
  connect(
    mapStateToProps,
    { getProfileCreated, getCompanies, applyForVaccancy }
  )
