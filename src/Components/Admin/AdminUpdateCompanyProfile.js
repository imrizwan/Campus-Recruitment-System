...
import { updateCompanyProfile, getCompanyProfileById } from "../../Actions/companyProfileActions";
import { getProfileCreatedById } from "../../Actions/profileActions";
...
class AdminUpdateCompanyProfile extends React.Component {
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.getcompanyprofilebyid) {
            // we are gonna check the profile
            const profile = nextProps.getcompanyprofilebyid;
    ...
    componentDidMount() {
        ...
        if (this.props.auth.isAuthenticated) {
            this.props.getCompanyProfileById(this.props.match.params.id);
            this.props.getProfileCreatedById(this.props.match.params.id);
        }
    ...
    onClick = (e) => {
        ...
        this.props.updateCompanyProfile(profileData, this.props.history, this.props.match.params.id);
    }
    ...
    render() {
        ...
        if (isEmpty(this.props.getcompanyprofilebyid) === null || isEmpty(this.props.profilecreated)) {
            return (
                <Loader />
            )
        } else {
...
export default compose(
    withStyles(styles),
    connect(mapStateToProps, { updateCompanyProfile, getCompanyProfileById, getProfileCreatedById })
)(withRouter(AdminUpdateCompanyProfile))