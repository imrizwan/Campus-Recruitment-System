...
import { addLanguages ,getProfileCreated } from '../Actions/profileActions';
...
class AddLanguages extends Component {
  ...
  onClick = (e) => {
    ...
    this.props.addLanguages(eduData, this.props.history);
  }
...
export default compose(
  withStyles(styles),
  connect(mapStateToProps, { addLanguages, getProfileCreated })
)(withRouter(AddLanguages))
